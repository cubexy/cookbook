...
type NumericTextFieldRootOwnProps = GetPropDefTypes<
  typeof textFieldRootPropDefs
> & {
...
type NumericTextFieldInputProps = ComponentPropsWithout<
  ...
  | "value"
>;
interface NumericTextFieldRootProps
  extends NumericTextFieldInputProps,
    MarginProps,
    NumericTextFieldRootOwnProps {}
const NumericTextFieldRoot = React.forwardRef<
  NumericTextFieldRootElement,
  NumericTextFieldRootProps
>((props, forwardedRef) => {
...
type NumericTextFieldSlotOwnProps = GetPropDefTypes<
  typeof textFieldSlotPropDefs
>;
interface NumericTextFieldSlotProps
  extends ComponentPropsWithout<"div", RemovedProps>,
    NumericTextFieldSlotOwnProps {}
const NumericTextFieldSlot = React.forwardRef<
  NumericTextFieldSlotElement,
  NumericTextFieldSlotProps
>((props, forwardedRef) => {
...
export {
  NumericTextFieldRoot as NumericInputRoot,
  NumericTextFieldSlot as NumericInputSlot
};
export type {
  NumericTextFieldRootProps as RootProps,
  NumericTextFieldSlotProps as SlotProps
};
